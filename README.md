...
- **Discoverable** — indexed on the FallMarket catalog at [sjgant80-hub.github.io/fallmarket/listing.html?id=fallimmig-us-api](https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallimmig-us-api)
...
- **Companion SDK** (`npm install @ai-native-solutions/fallimmig-us-api-sdk`) — programmatic JavaScript API for direct integration.
- **Companion MCP server** (`claude mcp add fallimmig-us-api -- npx -y @ai-native-solutions/fallimmig-us-api-mcp`) — Model Context Protocol server that any Claude/Cursor/Codex client can invoke as a tool.
- **Companion HTTP API** (`docker run --rm ghcr.io/sjgant80-hub/fallimmig-us-api-api`) — containerized REST endpoint for language-agnostic access.
...
- **Registry entry**: https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallimmig-us-api
- **Live URL**: https://sjgant80-hub.github.io/fallimmig-us-api/
- **Source**: https://github.com/sjgant80-hub/fallimmig-us-api
